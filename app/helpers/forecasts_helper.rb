module ForecastsHelper
  ...
  def wind_beaufort_scale(wind_speed)
    case wind_speed
    when 0..1 then "wind-beaufort-0.svg"
    when 2..5 then "wind-beaufort-1.svg"
    when 6..11 then "wind-beaufort-2.svg"
    when 12..19 then "wind-beaufort-3.svg"
    when 20..28 then "wind-beaufort-4.svg"
    when 29..38 then "wind-beaufort-5.svg"
    when 39..49 then "wind-beaufort-6.svg"
    when 50..61 then "wind-beaufort-7.svg"
    when 62..74 then "wind-beaufort-8.svg"
    when 75..88 then "wind-beaufort-9.svg"
    when 89..102 then "wind-beaufort-10.svg"
    when 103..117 then "wind-beaufort-11.svg"
